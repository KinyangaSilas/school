  ...
  redirect(web_root."admin/index.php");
                      ...
                      // $res = $autonum->single_autonumber(2);
                       ...
                       ?> 
 <form id="lessonupload" class="form-horizontal span6" action="controller.php?action=add" method="POST" enctype="multipart/form-data">
          ...
          <!-- /.col-lg-12 -->
            ...
            <div class="form-group">
                  <div class="col-md-11">
                      ...
                      "LessonSubject">Class/Form</label>

                      <div class="col-md-10">
                        <input name="deptid" type="hidden" value="">
                         <select class="form-control input-sm" id="LessonClass" name="LessonClass" placeholder=
                            "Chapter">
                            <?php
                             $mydb->setQuery("SELECT * FROM  `tblclass`");
                             $classess = $mydb->loadResultList();
                ...
                <div class="form-group">
                  <div class="col-md-11">
                      <label class="col-md-2 control-label" for=
                      "LessonSubject">Subject</label>

                      <div class="col-md-10">
                        <input name="deptid" type="hidden" value="">
                         <select class="form-control input-sm" id="LessonSubjectr" name="LessonSubject" placeholder=
                            "Chapter">
                             <?php
                             ...
                             foreach ($subjects as $subject) {
                              ...
                              echo "<option value=".$subject->SubjectName.">".$subject->SubjectName."</option>";
                             }
                            ?>
                         </select>
                      </div>
