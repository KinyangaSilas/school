 ...
 ?>
  ...
  ?>
    		    <v-list-item >
		          ...
		          <v-list-item-content>
		            <v-list-item-title>
		            	<a href="<?php echo web_root; ?>index.php?q=subject" data-toggle="collapse" href="#collapseExample"><i class="fa fa-user fa-fw"></i> Subjects</a>
		            </v-list-item-title>
		          </v-list-item-content>
		        </v-list-item>
  		        <v-list-item >
		          ...
		          <v-list-item-content>
		            <v-list-item-title>
		            	<a href="<?php echo web_root; ?>index.php?q=class" data-toggle="collapse" href="#collapseExample"><i class="fa fa-user fa-fw"></i> Class</a>
		            </v-list-item-title>
		          </v-list-item-content>
		        </v-list-item>
		        <v-list-item >
		          ...
		          <v-list-item-content>
		            <v-list-item-title>
		            	  <a href="<?php echo web_root; ?>books" data-toggle="collapse" href="#collapseExample"><i class="fa fa-user fa-fw"></i> Books</a>
		            </v-list-item-title>
		          </v-list-item-content>
		        </v-list-item>
...
<?php
		        ...
		        <v-list-item >
		          ...
		          <v-list-item-content>
		            <v-list-item-title>
		                <a href="<?php echo web_root; ?>index.php?q=about" ><i class="fa fa-user fa-fw"></i> About</a>
		            </v-list-item-title>
		          </v-list-item-content>
		        </v-list-item>
<!-- 		        <?php if($_SESSION['TYPE']=="Administrator"){ ?>
		       ...
		       <!--  <v-list-item >
		        ...
		        <v-list-item >
		          ...
		          <v-list-item-content>
		            <v-list-item-title>
		            	      <a href="<?php echo web_root; ?>feedback/index.php"><i class="fa fa-user fa-fw"></i> Feed Back </a> 
		            </v-list-item-title>
		          </v-list-item-content>
		        </v-list-item>
		        <v-list-item >
		          ...
		          <v-list-item-content>
		            <v-list-item-title>
		            	     <a href="<?php echo web_root; ?>/logout.php"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
		            </v-list-item-title>
		          </v-list-item-content>
		        </v-list-item>
		      </v-list-item-group>
