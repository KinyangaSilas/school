...
class Payment extends CI_Controller {
  ...
  public function confirm(){
	...
	public function callback()
	{
	  ...
	  $logFile = "Payment.json";
	  $log = fopen($logFile, "a");
	  fwrite($log, $stkCallbackResponse);
	  fclose($log);
	}
public function c2b($app_auth_key =false)
	{
...
if(isset($_POST['phone'])) $phone = $_POST['phone'];
  ...
  */
  ...
  $PartyA ='254790788100'; // This is your phone number, 
  $AccountReference = 'Binax Group';
  ...
  # callback url
    $CallBackURL='https://f3c2a932.ngrok.io/binax/projects/copy/pay.php';
